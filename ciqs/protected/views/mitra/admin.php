...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		*/
		array(
            'class'=>$buttonColumn,
            'template'=>"{view}{updatePassword}{update}{delete}",
            //--------------------- begin new code --------------------------
            'buttons'=>array(
						'view'=>
                            array(
                        ...
                        'updatePassword'=>
                            array(
                                    'url'=>'$this->grid->controller->createUrl("update", array("id"=>$data->primaryKey,"asDialog"=>1,"gridId"=>$this->grid->id, "scenario"=>"updatePassword"))',
