...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('dirut')); ?>:</b>
	<?php echo CHtml::encode($data->dirut); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('mr')); ?>:</b>
	<?php echo CHtml::encode($data->mr); ?>
	<br />
